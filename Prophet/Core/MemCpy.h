...
namespace Utils
{
	...
	{
#ifdef EOS_MEM_SIMD
		INLINE void MemCpySIMD(void* _dst, const void* _src, size _len)
		{
	...
	INLINE void MemCpy(void* _ptr, const void* _src, size _len)
	{
#ifdef EOS_MEM_SIMD
		if (IS_ALIGNED(_ptr, 16) && IS_ALIGNED(_src, 16))
		{
